...
```
## Included
- [x] [Buttons](https://github.com/react-native-community/react-native-purple#buttons)
- [x] [Social Icons / Buttons](https://github.com/react-native-community/react-native-purple#social-icons--buttons)
- [x] [Icons](https://github.com/react-native-community/react-native-purple#icons--icon-buttons)
- [x] [Side Menu](https://github.com/react-native-community/react-native-purple#sidemenu)
- [x] [Form Elements](https://github.com/react-native-community/react-native-purple#forms)
- [x] [Search Bar](https://github.com/react-native-community/react-native-purple#search-bar)
- [x] [ButtonGroup](https://github.com/react-native-community/react-native-purple#buttongroup)
- [x] [Checkboxes](https://github.com/react-native-community/react-native-purple#checkboxes)
- [x] [List Element](https://github.com/react-native-community/react-native-purple#lists)
- [x] [Linked List Element](https://github.com/react-native-community/react-native-purple#lists)
- [x] [Cross Platform Tab Bar](https://github.com/react-native-community/react-native-purple#cross-platform-tab-bar)
- [x] HTML style headings (h1, h2, etc...)
- [x] [Card component](https://github.com/react-native-community/react-native-purple#card)
- [x] [Pricing Component](https://github.com/react-native-community/react-native-purple#pricing-component)
...
- [ ] Something you's like to see? Submit an [issue](https://github.com/dabit3/react-native-purple/issues) or a [pull request](https://github.com/dabit3/react-native-purple/pulls)
...
```js
import { SideMenu, List, ListItem } from 'react-native-purple'
...
```js
import { SearchBar } from 'react-native-purple'
...
import { Tabs, Tab, Icon } from 'react-native-purple'
...
import { CheckBox } from 'react-native-purple'
...
```js
import { FormLabel, FormInput } from 'react-native-purple'
...
import { Card, ListItem, Button } from 'react-native-purple'
...
```js
import { PricingCard } from 'react-native-purple'
